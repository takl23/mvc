 ...
 */
final class Version20240805182804 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE renewable_energy_percentage (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, År INTEGER NOT NULL, varme_kyla_industri_mm INTEGER DEFAULT NULL, el INTEGER DEFAULT NULL, transporter INTEGER DEFAULT NULL, totalt INTEGER DEFAULT NULL)');
